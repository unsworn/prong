...
*******************************************************************************/
void 
follow_edges(unsigned char *edgemapptr, short *edgemagptr, short lowval, int cols)
{
    unsigned char *out_tempmapptr = edgemapptr;
    short *out_tempmagptr = edgemagptr;   
    bool start = false;
    do
    {
        start = false;
        edgemapptr = out_tempmapptr;
        edgemagptr = out_tempmagptr;
        ...
        for(i=0;i<8;i++)
        {
            ...
            if((*tempmapptr == POSSIBLE_EDGE) && (*tempmagptr > lowval))
            {
                *tempmapptr = (unsigned char) EDGE;
                ...
                out_tempmapptr = tempmapptr;
                out_tempmagptr = tempmagptr;       
...
void 
apply_hysteresis(short int *mag, unsigned char *nms, int rows, int cols, float tlow, float thigh, unsigned char *edge)
{
